...
import OneClickPay from "@/components/Header/OneClickPay";           // ← EKLENDİ
...
const AddToCart = ({ cartData, t }) => {
  ...
  // OneClickPay funksiyaları (yalnız bottom düymə üçün)
  ...
  const handleOverlayClick = (e) => {
    // OneClickPay içində overlay üçün e.target.className kontrolü istifadə olunursa uyğunluq üçün saxlanıldı
  ...
  return (
    <div className="container">
      {/* OneClickPay modal render — yalnız bottom düymə ilə açılacaq */}
      {showModal && (
        <OneClickPay
          t={t}
      ...
      <div className="row">
        ...
        <div className="xl-4 lg-4 md-4 sm-12">
          ...
          <div className="addToCartPaymentButtons">
            ...
            {/* Bottom "Bir kliklə al" — yalnız buradakı düymə modalı açır */}
            <button
              onClick={() =>
                openModal(
                  localCartAllData && localCartAllData.length
                    ? localCartAllData[0].product
                    : null
                )
              }
            >
