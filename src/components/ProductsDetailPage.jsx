...
//   // Notify handler (placeholder - buraya API çağırışı əlavə edə bilərsən)
//   const handleNotify = () => {
//     // TODO: Replace with real API call to register notification request
//     console.log(`Notify requested for product ${productId}`);
//     alert(
//       t?.notifyRequestSent || "Xəbər tələb edildi. Sənə bildiriş göndəriləcək."
//     );
//   };
...
//         /* === Sənin verdiyin dəqiq stil bloku burada === */
//         .productsDPaddToCart {
//           display: flex;
//           justify-content: center;
//           gap: 0.5rem;
...
//           width: 16rem;
//           height: 5.5rem;
//           background-color: #ec1f27; /* $MainColor -> #ec1f27 */
//           color: #fff;
//           font-size: 2rem;
//           font-weight: 500;
//           border-radius: 1rem;
...
//           background-color: #fff !important;
//           color: #111;
//           border: 1px solid #ec1f27; /* $MainColor -> #ec1f27 */
//           transition: all 0.4s ease-in-out;
//         }
//         /* === stil bloku bitdi === */
...
//         /* Yeni: not available depo styling (qırmızı) */
//         .depo.not-available {
//           color: #ec1f27;
//           font-weight: 600;
//         }

//         /* Yeni: notify button styling (eyni ölçü/forma ilə) */
//       `}</style>
//     </div>
//   );
// };
