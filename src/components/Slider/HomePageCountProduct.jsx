...
// components/HomePageCountProduct.jsx
"use client";
import Image from "next/image";
import Link from "next/link";
import React, { useState, useEffect } from "react";
  ...
  return (
    <div id="homePageCountProduct">
      ...
      <style jsx>{`
        ...
        /* Wishlist disabled style */
        .wishlist-btn:disabled {
          border: none;
        }

        /* IMPORTANT: add-to-cart disabled appearance (matches istədiyin görünüş) */
        .cartBtn:disabled {
          cursor: not-allowed;
          border: 1px solid #0CED4C;
          background: #fff;
          /* keep visible (don't dim too much) */
          opacity: 1;
        }
        .cartBtn:disabled span {
          color: #000;
        }
      `}</style>
    </div>
