...
export default function ProductsPage({
  ...
  const selectedMobileOption = mobileSortOptions.find(o => o.value === currentSort) || mobileSortOptions[0];
              ...
              <div className="filter-container">
                ...
                <div className="mobile-react-select-wrapper mobile-only">
                  <Select
                    ...
                    components={{ DropdownIndicator: () => null, SingleValue: () => t?.sortby || "Sırala" }} 
                    styles={{
                      control: (provided) => ({ ...provided, minHeight: 40, borderRadius: '1.5rem', boxShadow: 'none', borderColor: '#e6e6e6' }),
                      menu: (provided) => ({ ...provided, borderRadius: '1rem', overflow: 'visible', maxHeight: 'none' }),
                      menuList: (provided) => ({ ...provided, maxHeight: 'none', overflow: 'visible', padding: 6 }),
                      option: (provided, state) => ({ ...provided, padding: '10px 14px', fontSize: 16 }),
